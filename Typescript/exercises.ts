...
/*Ex-25 Alien Colors #3: Turn your if-else chain from Exercise 5-4 into an if-else chain.
...
alien_color = "green";
if(alien_color === "green") console.log("Congratulations, you just earned 5 points.");
else if (alien_color === "yellow") console.log("Congratulations, you just earned 10 points.");
else if (alien_color === "red") console.log("Congratulations, you just earned 15 points.");
...
/*Ex-26 Stages of Life: Write an if-else chain that determines a person’s stage of life. Set a value for the variable age, and then:
...
else if(Age == 20  || Age < 65) console.log("The person is an adult.");
else if(Age >= 65) console.log("The person is an elder.");

/*Ex-27 Favorite Fruit: Make a array of your favorite fruits, and then write a series of independent if statements that check for certain fruits in your array.
• Make a array of your three favorite fruits and call it favorite_fruits.
• Write five if statements. Each should check whether a certain kind of fruit is in your array.
If the fruit is in your array, the if block should print a statement, such as You really like bananas! */

let favorite_fruits: string[] = ["banana", "apple", "mango", "orange"];
...
if(favorite_fruits.includes("orange")) console.log("You really like oranges!")

/*Ex-28 Hello Admin: Make a array of five or more usernames, including the name 'admin'. Imagine you are writing code that will print a greeting to each user after they log in to a website. Loop through the array, and print a greeting to each user:
• If the username is 'admin', print a special greeting, such as Hello admin, would you like to see a status report?
• Otherwise, print a generic greeting, such as Hello Eric, thank you for logging in again. */

let userNames: string[] = ["Abdul Rehman", "admin", "Huzaifa", "Ali", "Hamza" ];
userNames.map((a)=>{
    if(a == "admin") console.log(`Hello admin, would you like to see a status report?`);
    else  console.log(`Hello ${a}, thank you for logging in again.`);
})

/*Ex-29 No Users: Add an if test to Exercise 28 to make sure the list of users is not empty.
...
/*Ex-30 Checking Usernames: Do the following to create a program that simulates how websites ensure that everyone has a unique username.
...
let current_users: string[] = ["Abdul Rehman", "aslam", "Huzaifa", "Ali", "Hamza"];
let new_users: string[] = ["Huzaifa", "rafay", "Ali", "khuzaima", "waseem"];
new_users.forEach((a)=>{
    let isExists = current_users.some((currentUser) => {
        return currentUser.toLowerCase() === a.toLowerCase();
    });
    if(isExists){
        console.log("The person will need to enter a new username.");
    }
    else console.log("The username is available.")
})

/*Ex-31 Ordinal Numbers: Ordinal numbers indicate their position in a array, such as 1st or 2nd. Most ordinal numbers end in th, except 1, 2, and 3.
...
num.forEach((a)=>{
    if(a == 1) console.log(`${a}st`);
    else if(a == 2) console.log(`${a}nd`);
    else if(a == 3) console.log(`${a}rd`);
    else console.log(`${a}th`);
})

/*Ex-32 Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then use a for loop to print the name of each pizza.
• Modify your for loop to print a sentence using the name of the pizza instead of printing just the name of the pizza. For each pizza you should have one line of output containing a simple statement like I like pepperoni pizza.
• Add a line at the end of your program, outside the for loop, that states how much you like pizza. The output should consist of three or more lines about the kinds of pizza you like and then an additional sentence, such as I really love pizza! */

let pizzaName: string[] = ["pepperoni", "faijita", "tikka"];
...
pizzaName.forEach((a)=>{
    console.log(`I like ${a} pizza.`);
})
console.log("I really love pizza!");

/*Ex-33 Animals: Think of at least three different animals that have a common characteristic. Store the names of these animals in a list, and then use a for loop to print out the name of each animal.
...
animals.forEach((a)=>{
console.log(`A ${a} would make a great pet.`);
})

console.log("Any of these animals would make a great pet!");

/*Ex-34 T-Shirt: Write a function called make_shirt() that accepts a size and the text of a message that should be printed on the shirt.
...
make_shirt("Medium", "No pain, No gain!");

/*Ex-35 Large Shirts: Modify the make_shirt() function so that shirts are large by default with a message that reads I love TypeScript.
Make a large shirt and a medium shirt with the default message, and a shirt of any size with a different message. */

let make_shirts = (size: string = "Large", message: string = "I love TypeScript"): void=>{
    console.log(`You have ordered a ${size}-sized shirt with the message: "${message}".`);
}

make_shirts();
make_shirts("Medium");
make_shirt("Small", "No pain, No gain!");

/*Ex-36 Cities: Write a function called describe_city() that accepts the name of a city and its country. The function should print a simple sentence,
...
let describe_city = (city: string = "Karachi", country: string = "Pakistan"): void => {
